...
//  Fire
//
//  移植自上游 qwertyyb/Fire 的偏好设置侧边栏重构（NavigationSplitView 风格），
//  并适配本项目的设置面板（含快捷键 / 学习等本地面板）。
//
...
///   - 每项带彩色渐变圆角徽章图标（20×20pt，cornerRadius:6）
///   - 收缩按钮在侧栏 toolbar 中
...
struct NativePreferencesView: View {
    ...
    private let panes: [PaneItem] = [
        ...
        PaneItem(id: "学习", icon: "brain", title: "学习", tint: .pink),
